import { Activity, RefreshCcw, Trophy, XCircle } from 'lucide-react';
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3 text-xs text-white/60">
              ...
              <span className="inline-flex items-center gap-1 rounded-md bg-white/5 px-2 py-1 text-emerald-300"><Trophy size={14} /> Wins: {stats?.wins || 0}</span>
              <span className="inline-flex items-center gap-1 rounded-md bg-white/5 px-2 py-1 text-rose-300"><XCircle size={14} /> Losses: {stats?.losses || 0}</span>
              <span className="rounded-md bg-white/5 px-2 py-1">Closed: {stats?.total || 0}</span>
            </div>
          </div>
