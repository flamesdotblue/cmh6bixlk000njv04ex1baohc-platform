...
export default function HeaderBar({ title, subtitle, wsStatus, latency, lastTick, onRefresh, loading }) {
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onRefresh}
              disabled={loading}
              className="inline-flex items-center gap-2 rounded-md border border-white/10 bg-white/10 px-3 py-2 text-sm text-white hover:bg-white/20 disabled:opacity-50"
            >
